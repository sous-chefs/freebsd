...
property :full_path, String, default: lazy { |r| r.dir_path + '/options' }
property :default_options, Hash, default: {}
property :current_options, Hash, default: {}
property :file_writer, String
...
def port_path
  ...
  raise Chef::Exceptions::Package, "Could not find port with the name #{@new_resource.name}" unless path
  path
end
